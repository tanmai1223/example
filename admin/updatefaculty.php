...
<div class="container" >
	...
	<div >
		...
		<input type="text"  class="form-control"  id="empid" name="empid" placeholder="Enter Employee Id" maxlength="6" required />&nbsp;&nbsp;
...
{
		$sql =" 
	UPDATE `faculty` SET `Name`='".$facname."',`Designation`='".$designation."',`Department`='".$department."',`Mobile_Number`='".$mobileno."',`Boarding_point`='".$boardingpoint."',`Route_no`='".$routeno."',Fee='".$total."',Due='".$DUE."',`Date_of_Payment`= '".$date."',`Remarks`= '".$remarks."',`acadyear`= '".$ay."',Verifiedby='".$usr."' where `Employee_Id`= '".$hallticket3."'";	
}
else
 	
		$sql =" 
	UPDATE `faculty` SET `Name`='".$facname."',`Designation`='".$designation."',`Department`='".$department."',`Mobile_Number`='".$mobileno."',`Boarding_point`='".$boardingpoint."',`Route_no`='".$routeno."',Fee='".$total."',Due='".$DUE."',`Date_of_Payment`= '".$date."',`Remarks`= '".$remarks."',`image_of_faculty`='".$image."',`acadyear`= '".$ay."',Verifiedby='".$usr."' where `Employee_Id`= '".$hallticket3."'";
//echo $sql;
 ...
 <div class="row">
	...
	<div class= "col-lg-4">
      <div class="form-group">
        ...
        <input type="number" class="form-control" id="hallticket5" value="<?php echo $row['Employee_id'];?>" name="hallticket5" maxlength="6" onChange="getwords()" placeholder="Enter hallticket" readOnly />
      </div>
    </div>
	<div class= "col-lg-4">
      <div class="form-group">
        <label for="Name">Name</label>
         <input type="text" class="form-control" id="facname" name="facname" value="<?php echo $row['Name'];?>" placeholder="Faculty name"  pattern="[A-Za-z ]{3,50}" title="No special characters, only characters of minimum 3 and maximum 30" maxlength="30" required />
      </div>
    </div>
...
e = document.getElementById('fee');
paidfee = document.getElementById('paid');
var previousfee = "<?php $pay = $row['Fee']-$row['Due'];echo $pay; ?>";
//alert(previousfee);
...
<div class="col-lg-4">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="remarks"  value="<?php echo $row['Remarks'];?>" name="remarks" maxlength="30" aria-describedby="Name" placeholder="Remarks" >
