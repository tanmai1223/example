	...
	<div class="col-lg-4">
      <div class="form-group">
       <label for="rcpno">Employee ID</label>
        <input type="text" class="form-control" id="empid" name="empid" onchange="getwords()" pattern="[0-9]{3,}" title="Invalid Employee Id" maxlength="6" placeholder="Employee Id" required />
      </div>
    </div>
