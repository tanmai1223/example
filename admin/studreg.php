...
{  var str =  ht.value;
   ...
   var dy = document.getElementById('detainyear');
     var dy1 = document.getElementById('Year');
    var d2 = d.getMonth(); 
	   if(d2<5)
		year = year -1; 
   ...
   if((year-res +1)>4)
    {   
		...
		//alert(str.substr(5,1));
	} 
   else
   { 
     document.getElementById("NO").checked = true;
     document.getElementById('Year1').value = year-res +1;
...
window.onclick = function(event) {
 ...
 <div class="form-group">
   ...
   <div class="col-lg-4" id="Year" >
   <div class="form-group">
    <label for="Year" >Year</label>
    <input type="text" class="form-control" id="Year1" name="Year" readonly />
