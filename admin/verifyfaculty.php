...
$row1=mysqli_query($conn,"SELECT * FROM `faculty` WHERE Employee_id='".$_POST['hallticket']."'");
...
alert('<?php echo "No word has been entered!";?>')
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="remarks" name="remarks" maxlength="30" value="<?php echo $row['Remarks'];?>" aria-describedby="Name" placeholder="Remarks" >
