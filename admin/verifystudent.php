...
$row1=mysqli_query($conn,"SELECT * FROM `student` WHERE HallticketNumber='".$_POST['hallticket']."'");
...
<div class="col-lg-4">
  <div class="form-group">
    ...
    <input type="text" class="form-control" pattern="[6789][0-9]{9}" title="Phone number starting with 6-9 and remaining 9 digit with 0-9" id="mobile" maxlength="10" name="mobile" placeholder="Enter Mobile No"  value="<?php echo $row['Mobile_Number']; ?>"  required />
   </div></div>
...
{ var dy = document.getElementById('confee');
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="remarks" name="remarks" maxlength="30" aria-describedby="Name" placeholder="Remarks" value="<?php echo $row['Remarks']?>"  />
