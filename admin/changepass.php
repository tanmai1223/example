...
$sql1=mysqli_query($conn,"select * from users where User_name = '".$_SESSION['username']."' and Password = '".$Oldpassword."'");
	$res=mysqli_num_rows($sql1);	
		//echo "select * from users where User_name = '".$_SESSION['username']."' and Password = '".$Oldpassword."'";
	if($res ==1)
	{		
$sql="update users set Password = '".$password."' where User_name = '".$_SESSION['username']."' and Password = '".$Oldpassword."'";
//echo $sql;
