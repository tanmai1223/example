...
<div class="left"> <!-- div for refresh icon -->
  ...
  $search_result = mysqli_query($conn, "SELECT * FROM route_master order by sno asc");
 ...
 <div class="form-group">
    ...
    <input type="text"  class="form-control" id="routeno" name="routeno" placeholder="Enter Route No" size="30" maxlength="4" required/>
  ...
  $('#routeno').on('keypress', function (event) {
 ...
 <div class="form-group">
    ...
    <input type="text"  class="form-control" id="routename" name="routename" placeholder="Enter Route Name" maxlength="30" required/>
 
  </div>
  </div>
   <script>
  
  $('#routename').on('keypress', function (event) {
 ...
 <div class="form-group">
    ...
    <input type="text"  class="form-control" id="busnumber" name="busnumber" placeholder="Enter Bus Number" maxlength="12"  required/>
 ...
 <div class="form-group">
    ...
    <input type="numeric"  class="form-control" id="capacity" name="capacity" placeholder="Enter Bus Number" maxlength="3" required/>
 
  </div>
  </div>
   <script>
  
  $('#capacity').on('keypress', function (event) {
 ...
 <div class="form-group">
    ...
    <input type="text"  class="form-control" id="drivername" name="drivername" placeholder="Enter Driver's Name" maxlength="30" required/>
 
  </div>
   <script>
  
  $('#drivername').on('keypress', function (event) {
 ...
 <div class="form-group">
    ...
    <input type="text" class="form-control" pattern="[6789][0-9]{9}" title="Phone number starting with 6-9 and remaining 9 digit with 0-9" id="drivernumber" name="drivernumber" aria-describedby="mobile" placeholder="Enter Driver Number" maxlength="10" required/>
    
  </div>
  </div>
   <script>
  
  $('#drivernumber').on('keypress', function (event) {
