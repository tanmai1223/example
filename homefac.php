	...
	<div class="col-lg-4">
      <div class="form-group">
       <label for="rcpno">Employee ID</label>
        <input type="text" class="form-control" id="empid" name="empid"  onchange="getwords()"  pattern="[0-9]{3,5}" title="Invalid Employee Id" maxlength="6" placeholder="Employee Id" required />
      </div>
    </div>
	<script>
...
<div class="col-lg-4">
  <div class="form-group">
    ...
    <input type="text" class="form-control" pattern="[6789][0-9]{9}" title="Phone number starting with 6-9 and remaining 9 digit with 0-9" id="mobile" maxlength="10" name="mobile" placeholder="Enter Mobile No" required>
   </div></div>
